...
GOOGLE_SCRIPT_URL = os.getenv("GOOGLE_SCRIPT_URL", "https://script.google.com/macros/s/AKfycbxsVInY9aVyNFCGeaan_G8KPk6eaOPhvgbLLl-5SowFOnxY8XzKVQMMW-5lzEyYoEgI/exec").strip()
