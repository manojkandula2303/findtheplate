...
GOOGLE_SCRIPT_URL = os.getenv("GOOGLE_SCRIPT_URL", "https://script.google.com/macros/s/AKfycbyTASvZfYljtHrOtQJziOlqGCqQHmUCcifX2efrK0NWlfYbU-TC98zyNbAcgZZVQjvb/exec").strip()
